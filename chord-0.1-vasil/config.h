...
/* Full path of arpcgen command */
#define PATH_ARPCGEN "/usr/local/bin/arpcgen"

/* Full path of rpcc command */
#define PATH_RPCC "/usr/local/bin/rpcc"

/* Full path of tame command */
#define PATH_TAME "/usr/local/bin/tame"
